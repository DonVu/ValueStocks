...
def ai_heuristic(company):
    ...
    return_on_equity = (int(company.income_statement[company.stock_name]['Net income']['2017-09']) /
        int(company.balance_sheet[company.stock_name]["Total stockholders' equity"]['2017-09']))
